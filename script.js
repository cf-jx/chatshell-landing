...
const translations = {
    'zh-CN': {
        ...
        privacy_li4: '语言和偏好设置存储于 chrome.storage.sync',
        privacy_li5: 'License Key 和激活状态存储于 chrome.storage.sync',
        privacy_li6: '使用计数存储于 chrome.storage.local',
