...
const translations = {
    'zh-CN': {
        ...
        feature_4_title: '选中导出',
        feature_4_desc: '只导出你选中的消息，支持时间戳/水印等偏好设置。',
        feature_5_title: '批量与附件',
        feature_5_desc: '批量导出多个对话，自动打包图片与文件（Pro）。',
        ...
        download_title: '开始使用',
        download_desc: '从 GitHub 获取最新版本，按说明安装即可。',
        download_meta: '当前版本：v4.0.1',
        download_action: '前往 GitHub 下载',
        // Legal pages
        privacy_title: '隐私政策',
    ...
    'en': {
        ...
        feature_4_title: 'Selective Export',
        feature_4_desc: 'Export only selected messages, with options like timestamps and watermark.',
        feature_5_title: 'Batch & Attachments',
        feature_5_desc: 'Batch export multiple chats and bundle images/files (Pro).',
        ...
        download_desc: 'Get the latest version from GitHub and follow the install instructions.',
        download_meta: 'Current version: v4.0.1',
        download_action: 'Download on GitHub',
        // Legal pages
