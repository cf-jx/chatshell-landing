...
const translations = {
    'zh-CN': {
        ...
        privacy_p5: '插件仅在 chatgpt.com / chat.openai.com / *.oaiusercontent.com 以及 License 服务器之间发起请求，所有请求均使用 HTTPS 协议。',
        ...
        faq_6_q: '需要哪些权限？',
        faq_6_a: '插件仅使用 storage 权限保存设置与 License 信息。导出仅在 chatgpt.com / chat.openai.com 页面运行；附件下载可能访问 *.oaiusercontent.com。',
        feedback_title: '问题反馈',
    ...
    'en': {
        ...
        faq_6_a: 'ChatShell only uses the storage permission to save preferences and license info. It runs on chatgpt.com / chat.openai.com; attachments may access *.oaiusercontent.com.',
